...
def _elevenlabs_tts(text, voice_id=None):
    ...
    payload = {"text": text, "model_id": "eleven_multilingual_v2", "voice_settings": {"stability": 0.4, "similarity_boost": 0.9}}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ ElevenLabs failed: {response.status_code}, using fallback.")
            return None
